...
class AccessModel
{
    ...
    public function verifyAuthentication($code)
    {
        ...
        $sql = "SELECT * FROM Authorization WHERE '{$code}' LIKE CONCAT(codePrefix COLLATE utf8mb4_general_ci, '%', codeSuffix COLLATE utf8mb4_general_ci) OR '{$code}' = CONCAT(codePrefix COLLATE utf8mb4_general_ci, codeCore COLLATE utf8mb4_general_ci, codeSuffix COLLATE utf8mb4_general_ci) OR authType = 'master'";
